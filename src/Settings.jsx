...
import { 
  ...
  Coffee, AlertTriangle, Check, Wrench, Languages, Bell, Shield, Settings as SettingsIcon, Github, MessageCircle
} from 'lucide-react';
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              cursor: 'pointer',
                              transition: 'all 0.2s ease',
                              opacity: (!isActive && mode.needsNpcap && !driverInstalled) ? 0.5 : 1,
                            }}
                          >
                            <span style={{ fontSize: '1.25rem', lineHeight: 1, flexShrink: 0 }}>{mode.icon}</span>
